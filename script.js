...
async function updateStatus(){
    ...
    try{
        ...
        const response = await fetch("http://172.20.10.4/status");
...
chat.innerHTML+=
`<div class="userBubble">${question}</div>`;
...
if(question.includes("hello") ||
   ...
   question.includes("hey"))
    return randomReply(helloReplies);
...
if(question.includes("status"))
    return "The current Baby Cry AI status is <b>" +
           currentStatus +
...
if(question.includes("confidence"))
    return "The current confidence is <b>" +
           confidence.toFixed(1) +
           "%</b>.";
...
chat.innerHTML=`
<div class="aiBubble">
👋 Hello! I'm your <b>Baby Care Assistant</b>.<br><br>

I can help answer questions about:<br><br>
...
The recommendation panel above will automatically update based on the AI detection from the ESP32.
</div>
`;
